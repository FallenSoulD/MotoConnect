        ...
        title: Row(
          children: [
            NeuAvatar(
              ...
              image: widget.eslesilenKisi.imageUrls.isNotEmpty
                  ? NetworkImage(widget.eslesilenKisi.imageUrls[0])
                  : null,
              child: widget.eslesilenKisi.imageUrls.isEmpty
                  ? const Icon(Icons.person, color: NeuColors.accentOrange, size: 18)
                  : null,
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: const TextStyle(fontSize: 11.5, color: NeuColors.accentOrange),
                  ),
                ],
              ),
            ),
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              const PopupMenuItem(
                ...
                child: Row(
                  children: [
                    Icon(Icons.report_problem_outlined, color: NeuColors.accentAmber, size: 20),
                    SizedBox(width: 8),
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<List<ChatMessage>>(
              ...
              builder: (context, snapshot) {
                ...
                if (messages.any((m) => m.senderId != widget.aktifKullanici.id && !m.isRead)) {
                  FirestoreService().markMessagesAsRead(_chatRoomId, widget.aktifKullanici.id);
                }
                    ...
                    child: Column(
                      ...
                      children: [
                        NeuContainer(
                          ...
                          borderRadius: 36,
                          child: const Icon(Icons.waving_hand, size: 48, color: NeuColors.accentOrange),
                        ),
                    ...
                    return Align(
                      ...
                      child: Container(
                        ...
                        child: NeuContainer(
                          ...
                          borderRadius: 18,
                          depth: 3,
                          color: benimMi ? NeuColors.accentOrange.withValues(alpha: 0.9) : NeuColors.surface,
                          borderColor: benimMi ? NeuColors.accentOrange : Colors.white.withValues(alpha: 0.05),
                          child: Column(
                            crossAxisAlignment:
          ...
          AnimatedCrossFade(
            ...
            firstChild: NeuContainer(
              ...
              child: Row(
                children: [
                  const Icon(Icons.shield_outlined, color: NeuColors.accentOrange, size: 16),
                  const SizedBox(width: 8),
                  const Expanded(
                    child: Text(
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: CircularProgressIndicator(
                              ...
                              strokeWidth: 2.5,
                              valueColor: const AlwaysStoppedAnimation<Color>(NeuColors.accentOrange),
